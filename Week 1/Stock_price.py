...
# x_train = data["Day"].values
# y_train = data["ClosingPrice"].values
...
#                                                  10000, cost_function, compute_gradient)

# plt.scatter(x_train, y_train, color = "Red", label = "Data")
# final_y = final_w * x_train + final_b
# plt.plot(x_train, final_y, color = "Yellow", label = "Fitted Line")
# plt.show()
